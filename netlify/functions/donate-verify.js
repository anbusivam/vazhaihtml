// Netlify Function: POST /donate/verify
...
exports.handler = async function (event, context) {
  ...
  try {
    ...
    if (!razorpay_order_id || !razorpay_payment_id || !razorpay_signature) {
      return { statusCode: 400, headers: CORS_HEADERS, body: JSON.stringify({ error: 'Missing payment verification fields.' }) };
    }
    ...
    if (expected !== razorpay_signature) {
      return { statusCode: 400, headers: CORS_HEADERS, body: JSON.stringify({ error: 'Payment signature mismatch. Payment could not be verified.' }) };
    }
